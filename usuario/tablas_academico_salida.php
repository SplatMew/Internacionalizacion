				...
				<table id="tabla" class="table table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th scope="col" class="text-center">CAMPUS SALIDA</th>
							<th scope="col" class="text-center">UNIDAD SALIDA</th>
							<th scope="col" class="text-center">PAIS RECEPTOR</th>
							<th scope="col" class="text-center">UNIDAD RECEPTORA</th>
							<th scope="col" class="text-center">ENTIDAD RECEPTORA</th>
...
<?php if($solicitudes == 0) {?>
	<div class="d-flex justify-content-center text-center h6">Actualmente no tiene ninguna movilidad solicitada</div>
<?php } else { ?>
					...
					<tbody>
						...
						?>
	                        <tr>
	                            ...
	                            <td class="text-center"> <?php echo $qq["UR"]; ?> </td>
