...
$sql = "SELECT * FROM estudiantes_salida"; 
...
<body>
	...
	<script>
        ...
        let tableExport = new TableExport($tabla, {
            ...
            filename: "Alumnos_Salida", //Nombre del archivo de Excel
            sheetname: "Alumnos_Salida", //Título de la hoja
        });
	...
	<script>
		$(document).ready(function() {
			...
			$('#tabla tbody').on('click', 'tr', function() {
				...
				//la matricula del renglo seleccionado
			});
		});
	</script>
</body>
