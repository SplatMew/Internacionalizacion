...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
	      ...
	      navVar("Sistema de Internacionalización > Estudiantes > Salida > Agregar Intercambio","../../public/assets/UABC_crop.png")
	    ?>
			...
			<div class="container">
				...
				<form action="../../php-partials/add.php" method="POST" autocomplete="off">
					...
					<div class="row mb-3 justify-content-md-center">
						<button type="submit" class="btn btn-outline-primary" name="btn_agregarIntercambio_salida" id="btnExportar">Agregar</button>
					</div>
				</form>
