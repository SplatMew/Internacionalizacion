...
$sql = "SELECT * FROM intercambio_estudiantil_salida_temporal";
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Estudiantes > Salida > Consultar Autorregistrados","../../public/assets/UABC_crop.png");
		    ?>
