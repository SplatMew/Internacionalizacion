...
$sql = "SELECT * FROM intercambio_estudiantil_salida";
...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Estudiantes > Salida > Consultar Intercambios","../../public/assets/UABC_crop.png");
		    ?>
	...
	<script>
        ...
        let tableExport = new TableExport($tabla, {
            ...
            filename: "Intercambio_Salida", //Nombre del archivo de Excel
            sheetname: "Intercambio_Salida", //Título de la hoja
        });
