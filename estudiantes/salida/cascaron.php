...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
	      ...
	      navVar("Sistema de Internacionalización > Estudiantes > Salida","../../public/assets/UABC_crop.png");
	    ?>
			
			<div class="container">
				<div class="h5 text-center mt-5 pt-5">Este módulo es para realizar las consultas y autorizaciones relacionadas con los estudiantes salen de la UABC a otras universidades</div>
			</div>
