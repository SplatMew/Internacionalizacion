...
if ($_SESSION["admin"] == 1)
    $sql = "SELECT * FROM estudiantes_entrada WHERE CAMPUS_ID=1";
//Administrador Tijuana
else if ($_SESSION["admin"] == 2)
    $sql = "SELECT * FROM estudiantes_entrada WHERE CAMPUS_ID=2";
//Administrador Ensenada
else if ($_SESSION["admin"] == 3)
    $sql = "SELECT * FROM estudiantes_entrada WHERE CAMPUS_ID=3";
//Administrador General o Super Usuario 
else if ($_SESSION["admin"] == 4 || $_SESSION["admin"] == 5)
    $sql = "SELECT * FROM estudiantes_entrada";
...
<body>
	...
	<div class="wrapper d-flex align-items-stretch" id="fondo_principal">
		...
		<div id="content" class="p-2  pt-5" >
            ...
            <?php
              ...
              navVar("Sistema de Internacionalización > Estudiantes > Visitantes > Consultar Estudiantes","../../public/assets/UABC_crop.png")
            ?>
                                ...
                                <?php while ($qq = mysqli_fetch_array($query)) {
                                   ...
                                   // $unit = mysqli_fetch_array($result); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!--Campus-->
                                            <?php if ($qq["CAMPUS_ID"] == 1) echo "MEXICALI"; ?>
                                            <?php if ($qq["CAMPUS_ID"] == 2) echo "TIJUANA"; ?>
                                            <?php if ($qq["CAMPUS_ID"] == 3) echo "ENSENADA"; ?>
                                        </td>

                                        <!-- td> <?php echo $unit["DESC"]; ?> </td>
    ...
    <script src="https://unpkg.com/pdf-lib@0.6.1/dist/pdf-lib.min.js"></script>
    ...
    <script>
        ...
        $btnExportar.addEventListener("click", function() {
            let tableExport = new TableExport($tabla, {
                ...
                filename: "Alumnos_visitantes", //Nombre del archivo de Excel
                sheetname: "Alumnos_Visitantes", //Título de la hoja
            });
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tabla tfoot th').each(function() {
                ...
                /*
                 else if (title == "DISCAPACIDAD" || title == "LENGUA INDIGENA" || title == "ORIGEN INDIGENA") {
                    $(this).html(`<select class="form-control">
                                    <option value="">--Selecciona--</option>
                    ...
                    //$(this).html('<input class="form-control" type="number" placeholder="Search ' + title + '" />');
                } else {
            ...
            $('#tabla tbody').on('click', 'tr', function() {
                ...
                window.location.href = "actualizar_estudiante.php?id=" + data[0];
