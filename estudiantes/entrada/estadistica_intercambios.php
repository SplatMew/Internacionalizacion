...
$sql = "SELECT * FROM intercambio_estudiantil_entrada";
	...
	<div class="wrapper d-flex align-items-stretch" id="fondo_principal">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
            ...
            <?php
              ...
              navVar("Sistema de Internacionalización > Estudiantes > Visitantes > Estadísticas de Intercambios","../../public/assets/UABC_crop.png")
            ?>
