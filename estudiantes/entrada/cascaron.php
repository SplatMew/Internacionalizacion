	...
	<div class="wrapper d-flex align-items-stretch" id="fondo_principal">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Estudiantes > Visitantes","../../public/assets/UABC_crop.png")
		    ?>

			<div class="container">
			<div class="h5 text-center mt-5 pt-5">Este módulo es para realizar las consultas y autorizaciones relacionadas con los estudiantes que vienen de otras universidades a la UABC</div>
			</div>
