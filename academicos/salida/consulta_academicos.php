...
$sql = "SELECT * FROM academicos_salida";
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Académicos > Salida > Consulta Académicos","../../public/assets/UABC_crop.png")
		    ?>

			<h5 class="mb-4 text-center">Consultar Académicos (Salida)</h5>
							...
							<tbody>
								<?php while ($qq = mysqli_fetch_array($query)) { ?>
									<tr>
										...
										<td> <?php echo $qq["EMPLEADO"]; ?> </td>
										<td> <?php echo $qq["EMPLEADO_APELLIDO1"]; ?> </td>
										<td> <?php echo $qq["EMPLEADO_APELLIDO2"]; ?> </td>
										<td>
											<!-- Sexo -->
	...
	<script>
		...
		$btnExportar.addEventListener("click", function() {
			let tableExport = new TableExport($tabla, {
				...
				filename: "Academicos_salientes", //Nombre del archivo de Excel
				sheetname: "Academicos_Salientes", //Título de la hoja
			});
