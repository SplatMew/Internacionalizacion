	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Académicos > Salida","../../public/assets/UABC_crop.png")
		    ?>

			<div class="container">
			<div class="h5 text-center mt-5 pt-5"> En este módulo podrá realizar las consultas y movimientos referentes a los académicos que salen de la UABC a otras universidades bajo el sistema de movilidad </div>
			</div>
