...
if ($query = mysqli_query($con, $sql)) { //$res = mysqli_fetch_array($query);
} else {
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Académicos > Salida > Consulta Movilidades","../../public/assets/UABC_crop.png")
		    ?>
            
            <h5 class="mb-4 text-center">Consultar Movilidades (Salida)</h5> <br>
                        ...
                        <table id="tabla" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php while ($qq = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        <th scope="row"> <?php echo $qq["EMPLEADO_ID"]; ?> </th>
                                        <td> <?php echo $qq["ID"]; ?> </td>
                                        <td> <?php echo $qq["UR_PAIS"]; ?> </td>
                                        <td> <?php echo $qq["UR"]; ?> </td>
                                        <td> <?php echo $qq["UR_ENTIDAD"]; ?> </td>
                                        <td>
                                            <!-- Tipo de Movilidad -->
                                        ...
                                        <td>
                                            <!-- Campus Emisor -->
                                            <?php if ($qq["CAMPUS_ID"] == '1') echo "Campus Mexicali"; ?>
                                            <?php if ($qq["CAMPUS_ID"] == '2') echo "Campus Tijuana"; ?>
                                            <?php if ($qq["CAMPUS_ID"] == '2') echo "Campus Ensenada"; ?>
                                        </td>
                                        <td>
                                            <!-- Entidad Emisora -->
                                            <?php if ($qq["CAMPUS_ID"] == '1') echo "Facultad de Ciencias"; ?>
                                            <?php if ($qq["CAMPUS_ID"] == '2') echo "Facultad de Ingeniería"; ?>
                                            <?php if ($qq["CAMPUS_ID"] == '2') echo "Facultad de Artes"; ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
            ...
            <button id="btnExportar" class="btn btn-success mb-5">
                <i class="fas fa-file-excel fa-sm fa-fw mr-2 "></i> Exportar Datos a Excel
            </button>

            <!--div class="row mb-3 justify-content-md-center">
                <input type="submit" value="Actualizar" class="btn btn-primary" name="btn">
            </div>

            <div class="row mb-3 justify-content-md-center">
                <input type="reset" class="btn btn-danger ml-2" value="Limpiar">
            </div-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tabla tfoot th').each(function() {
                ...
                } else if (title == "Tipo de Movilidad") {
                    $(this).html(`<select class="form-control border border-secondary">
                                    <option value="">
								        --Seleccionar--
							        </option>
							        ...
							        <option value="Estancia Sabática">
								        Estancia Sabática
							        </option>
							        <option value="Estancia de Investigación">
								        Estancia de Investigación
							        </option>
						        </select>`);

                } else if (title == "VISITANTE_ID") {
            ...
            var table = $('#tabla').DataTable({
                ...
                //La columna del id del intercambio no aporta informacion para el usuario,
            ...
            //forma previa de esconder la columna
            //table.column(1).visible(false);

            $('#tabla tbody').on('click', 'tr', function() {
                var data = table.row(this).data();
                //window.location.replace("update.php?id=" + data[0]);
                window.location.href = "actualizar_movilidad.php?id=" + data[1];
