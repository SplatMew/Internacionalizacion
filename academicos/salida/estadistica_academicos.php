	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-2 p-md-5 pt-5">
			...
			<?php
		      ...
		      navVar("Sistema de Internacionalización > Académicos > Salida > Estadísticas de Académicos","../../public/assets/UABC_crop.png")
		    ?>
			
			<h5 class="mb-4 text-center">Estadísticas Académicos (Salida)</h5>
