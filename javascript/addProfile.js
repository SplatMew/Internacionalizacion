function createFormProfile(){
    ...
    if(select=="1"){
        titulo.innerHTML=`<h5 class="text-center mt-4" id="title">Formulario crear cuenta para estudiante de la UABC</h5>
                <hr class="ms-5 me-5 ps-5 pe-5" />`;
        var form = document.getElementById("formSeleted");
        form.style.display = 'inline';
    }else if(select=="2"){
        titulo.innerHTML=`<h5 class="text-centerr mt-4" id="title">Formulario crear cuenta para estudiante que visita UABC</h5>
                <hr class="ms-5 me-5 ps-5 pe-5" />`;
    }else if(select=="3"){
        titulo.innerHTML=`<h5 class="text-centerr mt-4" id="title">Formulario crear cuenta para académico de la UABC</h5>
                <hr class="ms-5 me-5 ps-5 pe-5" />`;
    }else if(select=="4"){
        titulo.innerHTML=`<h5 class="text-centerr mt-4" id="title">Formulario crear cuenta para académico que visita  UABC</h5>
                <hr class="ms-5 me-5 ps-5 pe-5" />`;
    }else {
        titulo.innerHTML=``;
