<?php 
	...
	$empleado_id = mysqli_real_escape_string($con, $_POST['matricula']);
	$correo = mysqli_real_escape_string($con, $_POST['correo']);
	$sql = "SELECT * FROM usuarios WHERE matricula=${empleado_id} OR correo='${correo}'";
    ...
    if(!AddNewUserNOADMIN($_POST,$con,8)){
    	mysqli_close($con);
    ...
    $empleado = "'" . mysqli_real_escape_string($con, $_POST['nombre']) . "'";
    $empleado_apellido1 = "'" . mysqli_real_escape_string($con, $_POST['paterno']) . "'";
    $empleado_apellido2 = "'" . mysqli_real_escape_string($con, $_POST['materno']) . "'";
    ...
    $sql = "INSERT INTO perfil_academicos_salida (
    	EMPLEADO_ID, EMPLEADO, EMPLEADO_APELLIDO1, EMPLEADO_APELLIDO2,
    ...
    if (mysqli_query($con, $sql)) {
        mysqli_close($con);
        PantallaError("../public/assets/UABC_crop.png","OPERACIÓN EXITOSA","Su perfil de académico local de UABC fue creado exitosamente en el sistema de internacionalización, ahora puede acceder utilizando su correo y contraseña en la página de inicio.",0);
    } else {
    	mysqli_close($con);
