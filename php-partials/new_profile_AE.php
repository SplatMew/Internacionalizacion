<?php 
    ...
    if(!AddNewUserNOADMIN($_POST,$con,7)){
    	mysqli_close($con);
    ...
    $sql = "INSERT INTO perfil_academicos_entrada (
    ...
    if (mysqli_query($con, $sql)) {
        mysqli_close($con);
        PantallaError("../public/assets/UABC_crop.png","OPERACIÓN EXITOSA","Su perfil de académico visitante fue creado exitosamente en el sistema de internacionalización, ahora puede acceder utilizando su correo y contraseña en la página de inicio.",0);
    } else {
    	mysqli_close($con);
